      ...
      >
        ...
        >
          <span
            className={`${styles.clickable}`}
            data-type="guide"
            data-category="تتبع طلبك"
            data-title="تتبع طلبك"
          ></span>
        ...
        >
          <span
            className={`${styles.clickable}`}
            data-type="guide"
            data-category="الدفع لطلب"
            data-title="الدفع لطلب"
          ></span>
        ...
        >
          <span
            className={`${styles.clickable}`}
            data-type="guide"
            data-category="إلغاء منتج أو طلب"
            data-title="إلغاء منتج أو طلب"
          ></span>
          <p className={`${styles.txt}`}>Track Your Order</p>
          <img
            className={styles.img}
        ...
        >
          <span
            className={`${styles.clickable}`}
            data-type="guide"
            data-category="عمل طلب إرجاع"
            data-title="عمل طلب إرجاع"
          ></span>
